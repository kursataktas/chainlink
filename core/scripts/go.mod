...
require (
	...
	github.com/smartcontractkit/chainlink/integration-tests v0.0.0-20241025180025-f7b25441dc96
	github.com/smartcontractkit/chainlink/v2 v2.14.0-mercury-20240807.0.20241025180025-f7b25441dc96
